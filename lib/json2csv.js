 ...
 * @property {String} [doubleQuotes='""'] - the value to replace double quote in strings
...
function checkParams(params) {
  ...
  //#check double quote
  params.doubleQuotes = typeof params.doubleQuotes === 'string' ? params.doubleQuotes : Array(3).join(params.quote);
